...
public class AplicatieCuDecorator {
    public static void main(String[] args) {
        ...
        IStudentiExport exportConsola = new StudentiExportCuTimp(new StudentiInConsola());
        exporter.startExport(exportConsola, studenti);

        IStudentiExport exportText = new StudentiExportCuTimp(new StudentiInFisierText("studentiDecoratorText.txt"));
        exporter.startExport(exportText, studenti);

        IStudentiExport exportXlsx = new StudentiExportCuTimp(new StudentiInFisierXlsx("studentiDecoratorExcel.xlsx"));
        exporter.startExport(exportXlsx, studenti);
    }
}
